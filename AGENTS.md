...
- 当前实现状态以 `PROJECT_INDEX.md` 为准，已交付变化以 `CHANGELOG.md` 为准，禁止把 PRD 中的目标能力表述为已经完成。
...
- 普通提交的 Commit SHA 不重复写入 `CHANGELOG.md`、`plans/*.md`、`plans/INDEX.md` 或 `PROJECT_INDEX.md`。这些文档分别记录已交付变化、实施背景与验证、计划永久登记、当前事实与导航。
