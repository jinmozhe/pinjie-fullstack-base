...
| 派生类型 | 无 |
| 母版基线 | 当前仓库 |
| 当前阶段 | 正在修复三端生产运行镜像漏洞阻断并完成 v0.1.1 不可变发布；旧版管理员确认端点限时保留至 2026-09-26 |
...
| 计划 | 状态 | 说明 |
| --- | --- | --- |
| [Backend 基础镜像漏洞阻断修复与 v0.1.1 发布计划](plans/2026-08-30_Backend基础镜像漏洞阻断修复与v0.1.1发布计划.md) | 实施中 | 修复三端候选镜像扫描阻断并完成三镜像不可变发布 |
