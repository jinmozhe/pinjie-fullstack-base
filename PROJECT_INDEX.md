...
| 派生类型 | 无 |
| 母版基线 | 当前仓库 |
| 当前阶段 | v0.1.1 不可变发布与三端 GHCR 镜像发布已完成，生产部署未触发；TCR 个人版双仓发布第一阶段实施中，生产地域与只读身份待确认；旧版管理员确认端点限时保留至 2026-09-26 |
...
| 计划 | 状态 | 说明 |
| --- | --- | --- |
| [TCR 个人版双仓镜像发布与腾讯云内网部署计划](plans/2026-08-31_TCR个人版双仓镜像发布与腾讯云内网部署计划.md) | 实施中 | 发布兼容性实现与测试推送已授权，生产地域、只读身份和部署继续锁定 |
