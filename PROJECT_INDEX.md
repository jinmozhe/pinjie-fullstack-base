...
| 派生类型 | 无 |
| 母版基线 | 当前仓库 |
| 当前阶段 | v0.1.1 不可变发布与 1Panel 共享基础设施生产链路已建立；CNB 三端独立发布已完成本地实施与轻量验证，GitHub 到 CNB 的默认严格、可显式快速双验证模式正在实施，真实发布仍待独立授权；旧版管理员确认端点限时保留至 2026-09-26 |
...
| 计划 | 状态 |
| --- | --- |
| [GitHub 源码交接双验证模式计划](plans/2026-09-04_GitHub源码交接双验证模式计划.md) | 实施中 |
| [CNB 三端独立镜像构建与发布证据改造计划](plans/2026-09-04_CNB三端独立镜像构建与发布证据改造计划.md) | 实施中 |
