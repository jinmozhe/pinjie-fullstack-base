import { fetchAuthenticationState, fetchInitialSystemStatus } from "@/lib/api/server";
...
export default async function HomePage() {
  const [status, authenticationState] = await Promise.all([
