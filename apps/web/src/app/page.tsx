...
export default async function HomePage() {
  const [status, authenticationState, registrationState] = await Promise.all([
    fetchInitialSystemStatus(),
    fetchAuthenticationState(),
    fetchRegistrationState(),
  ]);
