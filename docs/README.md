...
| [codex-windows-config-acl-governance.md](operations/codex-windows-config-acl-governance.md) | Codex Windows `config.toml`、默认联网、Schannel、`elevated + Custom`、ACL 诊断、验证、最小修复和回滚标准 |
