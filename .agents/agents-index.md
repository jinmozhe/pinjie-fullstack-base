...
| 路径 | 状态 | 影响范围 | 用途 |
| --- | --- | --- | --- |
| `plans/2026-08-22_GitHubActionsNode24原生运行时升级计划.md` | 实施中 | Deployment、Documentation | 十个 Action 的本地升级与验证已完成，等待提交、推送及线上告警归零验证 |
...
| 路径 | 状态 | 结果 | 影响范围 | 用途 |
| --- | --- | --- | --- | --- |
| `plans/2026-08-22_GitHubActionsNode24原生运行时升级计划.md` | 实施中 | 本地实施与验证完成；等待提交、推送及线上四个自动工作流的 Node.js 20 告警归零验证 | Deployment、Documentation | 将七个工作流中的十个 Action 升级到原生 Node.js 24 的固定 SHA |
